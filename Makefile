...
build/ef/loader.prg: build/ef/loader.o build/ef/io-data.o
...
# cartridge binary
build/ef/u5remastered.bin: build/ef/directory.data.prg build/ef/files.data.prg build/ef/exodecrunch.prg build/ef/init.prg build/ef/loader.prg src/ef/eapi-am29f040.prg build/ef/io-replacement.prg build/ef/io-addendum.prg build/ef/temp.subs.patched.prg build/ef/crt.blocks.map
