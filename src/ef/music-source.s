...
.export _sid_initialize
.export _sid_initialize_waitforirq
.export _sid_mute
.export _sid_process
.export _sid_transfer

.import music_info
.import music_voice_decisions
.import music_workplace_7219
...
;        jsr 0x78a6 ; transfer data to sid
    ...
    :   lda #$9a
     ...
     _sid_initialize_waitforirq:
        ldx #$00
        ldy #$00
        lda music_workplace_7219 + $13
    :   cmp music_workplace_7219 + $13
        bne :+
        dey                         
        bne :-
        dex                         
